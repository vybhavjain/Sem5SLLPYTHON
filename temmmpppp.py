def farenheittocelcius():
	temp=int(raw_input("Please enter the farenheit temperature"))
	celcius= ((temp-32)*5)/9
	print celcius
	return
...
def celciustokelvin():
	temp=int(raw_input("Please enter the celcius temperature"))
	celcius= temp+273
	print celcius
	return
...
def kelvintofarenheit():
	temp=int(raw_input("Please enter the kelvin temperature"))
